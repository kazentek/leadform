...
...(payload.client_ip_address ? { client_ip_address: payload.client_ip_address } : {}), // Added IP (Unhashed)
...(payload.client_user_agent ? { client_user_agent: payload.client_user_agent } : {}), // Added User Agent (Unhashed)
...
const capiPayload = {
  ...
  fbp: fbp || null,
  fbc: fbc || null,
  client_ip_address: clientIp,  // Pass extracted IP to CAPI
  client_user_agent: userAgent, // Pass extracted User Agent to CAPI
};
try {
